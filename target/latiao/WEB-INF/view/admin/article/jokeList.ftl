    ...
    <div class="col-xs-12">
        <div class="box">
            ...
            <div class="box-body">
                ...
                <table id="jokeList_tab" class="table table-bordered table-striped">
                    <thead>
                    <tr>
...
<script type="text/javascript">
    ...
    $(function () {
        ...
        var No = 0;
        jokeList_tab = $('#jokeList_tab').DataTable({
            "dom": "itflp",
            "processing": true,
            "searching": false,
            ...
            "ajax": function (data, callback, settings) {
                ...
                //ajax请求数据
                $.get('${api}/article/joke/' + param.page + '/' + param.limit, function (result) {
                    console.log(result);
                    //封装返回数据
                    var returnData = {};
    ...
    function emailAccountInfoToListAjax() {
        list_ajax = jokeList_tab;
    }
    function emailAccountInfoReload() {
        reloadTable(jokeList_tab, "#accountInfoTime", "#accountInfoPremise");
    }
</script>